...
const AccordionItem = ({ header, ...rest }) => {
  ...
  return <Item   {...rest} header={({ state: { isEnter } }) => (
    ...
    className="border-b border-gray-400"  buttonProps={{ className: ({ isEnter }) =>  `flex w-full py-3 md:py-2 lg:py-3 xl:py-6 text-left hover:bg-gray-50/60 ${ isEnter? "text-[#FF8C46]" : 'text-black/80'    }`
    }} 
