...
import { changeQuantity, removeProductFromCart, TCartItem } from "../redux/features/cart/cartSlice";
      ...
      <div className="overflow-hidden">
        <table
          ...
          <thead className="border-b font-medium dark:border-neutral-500">
            <tr className="bg-gray-500 text-white/95 text-[12px] md:text-base">
              <th
                scope="col"
...
<button className="bg-gray-700 rounded-md py-3 px-8 my-4 text-white font-semibold transition-all hover:bg-red-600 text-sm md:text-lg">Place Order</button>
   </section>
  )
}
